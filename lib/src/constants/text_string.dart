...
const String mSignUpSubTitle =
    "Creat user profile to start your Journey with us..";
const String mFullName = "Full Name";
const String mPhoneNo = "Phone No";
...
const String mProfileSubHeading = "admin@gmail.com";
const String mEditProfie = "Edit Profile";
const String mSubmmit = "Submmit";
