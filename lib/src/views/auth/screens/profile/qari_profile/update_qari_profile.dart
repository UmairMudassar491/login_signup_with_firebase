...
class UpdateQariProfile extends StatefulWidget {
  const UpdateQariProfile({super.key});

  @override
  State<UpdateQariProfile> createState() => _UpdateQariProfileState();
}

class _UpdateQariProfileState extends State<UpdateQariProfile> {
                    ...
                    builder: (BuildContext context,
                      ...
                      if (snapshot.connectionState == ConnectionState.done) {
                        if (snapshot.hasData) {
                          ...
                          final hourlyRate =
                              TextEditingController(text: data['hourlyRate']);
                          // final specializations = TextEditingController(
                          //     text: data['specializations']);
                          final password =
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              //   decoration: const InputDecoration(
                              //       prefixIcon: Icon(Icons.location_pin),
                              //       labelText: mSpecializations,
                              //       hintText: mSpecializations,
                              //       border: OutlineInputBorder()),
                              //   validator: ((value) {
                              //     if (value == null || value.isEmpty) {
                              //       return "Please enter the specializations";
                              //     } else {
                              //       return null;
                              //     }
                              //   }),
                                  ...
                                  onPressed: () async {
                                    ...
                                    try {
                                      await DatabaseService(
                                          ...
                                          .updataQariesData(qaries)
                                          .then((value) {
                                        Fluttertoast.showToast(
                                            msg: "Profile Upload");
                                        Navigator.pushReplacementNamed(
                                            context, '/QariHomePage');
                                        setState(() {
                                          isLoading = false;
                                        });
                                      });
