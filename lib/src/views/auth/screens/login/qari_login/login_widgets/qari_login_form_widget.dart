...
class QariLoginForm extends StatefulWidget {
  const QariLoginForm({super.key});

  @override
  State<QariLoginForm> createState() => _QariLoginFormState();
}

class _QariLoginFormState extends State<QariLoginForm> {
        ...
        child: Column(
          ...
          children: [
            TextFormFieldWidget(
              ...
              prefixIconWidget: const Icon(Icons.email_outlined,color: primaryColor,),
              validator: (value) {
            ...
            TextFormFieldWidget(
              ...
              obscuringCharacter: "*",
              maxLines: 1,
              prefixIconWidget: const Icon(Icons.lock,color: primaryColor,),
                ...
                children: [
                  TextSpan(
                    ...
                    recognizer: TapGestureRecognizer()
                      ..onTap = () =>
                          Navigator.pushNamed(context, "/SignUpQariScreen"),
                  ),
                ],
              ),
            ),
      ...
      try {
        await authRepository
          ...
          if (value == true) {
            ...
            await HelperFunctions.saveQariLoggedInStatus(true);
            //await HelperFunctions.saveUserEmailSF(email.text.trim());
            //await HelperFunctions.saveUserNameSF(snapshot.docs[0]['fullName']);
            // ignore: use_build_context_synchronously
            Navigator.pushReplacementNamed(context, '/QariHomePage');
          } else {
            setState(() {
              isLoading = false;
            });
